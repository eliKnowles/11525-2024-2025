	...
	public class outtake {
		...
		public class vSlidePIDF implements Action {
			...
			public boolean run (@NonNull TelemetryPacket packet) {
				...
				vSlideMotorOne.setPositionWithPIDF(vSlideTarget,
				                                   vSlideMotorOne.getCurrentPosition());
				vSlideMotorTwo.setPower(vSlideMotorOne.getPower());
//                vSlideMotorTwo.setPower(vSlideMotorOne.getPower());
				
				telemetry.addData("Ticks",
				                  "VSlideMotorTwo: " + vSlideMotorTwo.getCurrentPosition());
				telemetry.addData("Ticks",
				                  "vSlideMotorOne: " + vSlideMotorOne.getCurrentPosition());
				telemetry.update();
				return true;
			}
		}
...
//        int initialPosition = 1;
		...
		TrajectoryActionBuilder score_first_sample_position = drive.actionBuilder(
				new Pose2d(37, 65, Math.toRadians(270)))
			.strafeTo(new Vector2d(37, 50))
			.setReversed(true)
			.setTangent(Math.toRadians(45))
			.splineTo(new Vector2d(56.5, 56.5), Math.toRadians(0));
		TrajectoryActionBuilder grab_second_sample = drive.actionBuilder(
				new Pose2d(56.5, 56.5, Math.toRadians(315)))
			.waitSeconds(.3)
			.setReversed(false)
			.strafeToLinearHeading(new Vector2d(49, 50), Math.toRadians(270))
			.strafeTo(new Vector2d(49, 37));
		TrajectoryActionBuilder score_second_sample = drive.actionBuilder(
				new Pose2d(49, 37, Math.toRadians(270)))
			.waitSeconds(.3)
			.strafeToLinearHeading(new Vector2d(56.5, 56.5), Math.toRadians(225));
		TrajectoryActionBuilder grab_third_sample = drive.actionBuilder(
				new Pose2d(56.5, 56.5, Math.toRadians(315)))
			.waitSeconds(.3)
			.setReversed(false)
			.strafeToLinearHeading(new Vector2d(58, 50), Math.toRadians(270))
			.strafeTo(new Vector2d(60, 37));
		TrajectoryActionBuilder score_third_sample = drive.actionBuilder(
				new Pose2d(60, 37, Math.toRadians(270)))
			.waitSeconds(.3)
			.strafeToLinearHeading(new Vector2d(56.5, 56.5), Math.toRadians(225));
		TrajectoryActionBuilder grab_fourth_sample = drive.actionBuilder(
				new Pose2d(56.5, 56.5, Math.toRadians(225)))
			.waitSeconds(.3)
			.strafeToLinearHeading(new Vector2d(45, 26.5), Math.toRadians(0))
			.strafeTo(new Vector2d(59, 26.75));
		TrajectoryActionBuilder score_fourth_sample_drive_away = drive.actionBuilder(
				new Pose2d(59, 26.75, Math.toRadians(0)))
			.waitSeconds(.2)
			.strafeToLinearHeading(new Vector2d(44, 26.5), Math.toRadians(0));
		
		TrajectoryActionBuilder score_fourth_sample = drive.actionBuilder(
				new Pose2d(44, 26.5, Math.toRadians(-135)))
			.waitSeconds(.3)
			.strafeToLinearHeading(new Vector2d(56.5, 56.5), Math.toRadians(225));
		TrajectoryActionBuilder score_fourth_sample_drive_away2 = drive.actionBuilder(
				new Pose2d(56.5, 56.5, Math.toRadians(225)))
...
//        }
		Actions.runBlocking(new ParallelAction(claw.SlidePIDF(), claw.HSlideIdle(),
		                                       new SequentialAction(claw.sampleScoring(),
