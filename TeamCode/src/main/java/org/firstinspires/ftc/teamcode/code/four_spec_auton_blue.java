...
//        int initialPosition = 1;
		...
		TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(-5, 30.4, Math.toRadians(90)))
			...
			.splineTo(new Vector2d(-50, 1), Math.toRadians(270)) // align with first sampleample
		...
		TrajectoryActionBuilder tab4 = drive.actionBuilder(
				new Pose2d(-45, 60.5, Math.toRadians(90)))
			.setReversed(false)
		...
		TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(2, 30.4, Math.toRadians(90)))
			.setTangent(90)
			.splineToLinearHeading(new Pose2d(-45, 50, Math.toRadians(270)),
			                       Math.toRadians(90))//position for intaking 2nd
		...
		TrajectoryActionBuilder tab7 = drive.actionBuilder(
				new Pose2d(-45, 60.5, Math.toRadians(90)))
			.setTangent(Math.toRadians(-90))
			.splineToLinearHeading(new Pose2d(5, 50, Math.toRadians(90)),
			                       Math.toRadians(270)) //intak
			.waitSeconds(.1)
			.strafeTo(new Vector2d(5, 30.4));
		
		TrajectoryActionBuilder tabIntakePosition4th = drive.actionBuilder(
				new Pose2d(5, 30.4, Math.toRadians(90)))
			.setTangent(90)
			.splineToLinearHeading(new Pose2d(-45, 50, Math.toRadians(90)),
			                       Math.toRadians(270))//position for intaking
			//grab 2nd
			.waitSeconds(.4);
		TrajectoryActionBuilder tabIntake4th = drive.actionBuilder(
				new Pose2d(-45, 50, Math.toRadians(270)))
			.strafeTo(new Vector2d(-45, 60.5))
			
			.waitSeconds(.3);
		TrajectoryActionBuilder tabPlace4th = drive.actionBuilder(
				new Pose2d(-45, 60.5, Math.toRadians(90)))
			.setTangent(Math.toRadians(-90))
			.splineToLinearHeading(new Pose2d(-8, 50, Math.toRadians(90)),
			                       Math.toRadians(270)) //intak
		...
		Actions.runBlocking(new ParallelAction(claw.SlidePIDF(), claw.HSlideIdle(),
		                                       new SequentialAction(claw.specimenScoring(),
		                                                            tab1.build(),
