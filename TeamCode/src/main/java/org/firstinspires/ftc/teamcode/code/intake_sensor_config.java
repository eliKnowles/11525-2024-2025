...
@TeleOp
public class intake_sensor_config extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 17); // 20mm or closer requirement
        ...
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 17); // 20mm or closer requirement
