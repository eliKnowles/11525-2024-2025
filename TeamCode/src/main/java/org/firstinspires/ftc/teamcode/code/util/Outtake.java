...
public class Outtake implements Subsystem {
    ...
    private static OuttakeState currentState = OuttakeState.RETRACTED;

    public OuttakeState getState() {
        return currentState;
    }

    public static void setState(OuttakeState newState) {
...
//        );
//    }
    public static Lambda extendArmSample() {
        return new Lambda("extend-arm-sample")
                .setInit(() -> {
                    setPivot(0.67);
                    setLinkage(0.15);
                    new Wait(0.1);
                    setLinkage(0.36);
                    setPivot(0.8);
                    setState(OuttakeState.EXTENDED);
                })
                .setFinish(() -> true);
    }
...
//        );
//    }
    public static Lambda retractArmSample() {
        return new Lambda("retract-arm-sample")
            .setInit(() -> {
                setLinkage(0.05);
                new Wait(0.1);
                setPivot(0.5);
                setState(OuttakeState.RETRACTED);
            })
            .setFinish(() -> true);
    }
...
//        );
//    }
    public static Lambda grabSpecimen() {
        return new Lambda("grab-specimen")
            .setInit(() -> {
                setLinkage(0.00);
                new Wait(0.2);
                setPivot(0);
                setState(OuttakeState.SPECIMEN_WALL);
            })
            .setFinish(() -> true);
    }
...
//        );
//    }
    public static Lambda scoreSpecimen() {
        return new Lambda("score-specimen")
            .setInit(() -> {
                setLinkage(0.00);
                setLinkage(0.00);
                new Wait(0.2);
                ...
                new Wait(0.3);
                setLinkage(0.32);
                setState(OuttakeState.RETRACTED_SPEC);
            })
            .setFinish(() -> true);
    }
